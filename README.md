...
Файлов два, по архитектуре процессора: `OpenDisk-<версия>-x64.exe` для обычных
компьютеров и `OpenDisk-<версия>-arm64.exe` для ноутбуков на ARM (Snapdragon
и подобные). Если не уверены — почти наверняка нужен x64.
