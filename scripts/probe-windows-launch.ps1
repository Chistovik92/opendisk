...
# графической подсистемы вообще. Так было на ARM-раннере GitHub: его сеанс висит
# на экране первой настройки Windows, и лаунчер там не завершался даже с
# --cleanup, хотя консольный rclone работал.
