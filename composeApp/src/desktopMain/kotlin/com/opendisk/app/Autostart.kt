...
object Autostart {
     ...
     */
    /**
     * Путь к лаунчеру установленного приложения или null при запуске
     * из исходников. Тем же путём пользуется обновление, чтобы запустить
     * новую версию после установки.
     */
    fun launcherPath(): String? = resolveTarget()?.command
