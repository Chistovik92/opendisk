    ...
    application {
        ...
        nativeDistributions {
            ...
            macOS {
                ...
                // поэтому для него версия отдельная: 0.5.6 → 1.5.6. Выводится из
                // общей, а не пишется руками — в 0.5.6 её забыли поднять, и .dmg
                // вышли под номером прошлого выпуска.
                packageVersion = "1." + project.version.toString().substringAfter('.')
            }
        }
    }
}
